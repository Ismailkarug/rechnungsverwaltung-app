...
export default function AsyncZIPImportDialog({ open, onOpenChange, onImportComplete }: AsyncZIPImportDialogProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      formData.append('invoiceType', 'Eingang'); // Eingangsrechnungen
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Laden Sie ZIP-Dateien mit bis zu 500+ Rechnungen hoch. Der Import läuft im Hintergrund - Sie können weiterarbeiten!
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                ...
                <label htmlFor="zip-file-input" className="cursor-pointer">
                  ...
                  <p className="text-xs text-gray-500">
                    Unterstützt große Dateien mit 500+ PDF-Rechnungen
                  </p>
                </label>
              </div>
