...
import { Download, Calendar, TrendingUp, TrendingDown, DollarSign, Package, AlertCircle } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function EbayFinanceClient() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      toast.error('Fehler beim Laden der eBay-Daten');
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportToCSV = () => {
    ...
    const csvContent = [
      ...
      [''],
      ['Gebühren'],
      ['eBay Verkaufsprovisionen', `€${data.summary.fees.platformFees.toFixed(2)}`],
      ['Zahlungsgebühren', `€${data.summary.fees.paymentFees.toFixed(2)}`],
      ['Werbekosten', `€${data.summary.fees.adCosts.toFixed(2)}`],
    ...
    link.download = `ebay_finance_${format(new Date(), 'yyyy-MM-dd')}.csv`;
    link.click();
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Lade eBay-Daten...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            <div className="bg-yellow-100 p-2 rounded-lg">
              <svg className="h-8 w-8" viewBox="0 0 48 48" fill="none">
                ...
                <text x="24" y="32" textAnchor="middle" fill="white" fontSize="24" fontWeight="bold">e</text>
              </svg>
            </div>
            eBay Finance
          </h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>eBay Gebührenaufschlüsselung</CardTitle>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium">eBay Verkaufsprovisionen</p>
                <p className="text-sm text-gray-500">Ca. 10-12% vom Verkaufspreis</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-500">PayPal / eBay Managed Payments</p>
              </div>
              <div className="text-right">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-500">Promoted Listings / Anzeigen</p>
              </div>
              <div className="text-right">
